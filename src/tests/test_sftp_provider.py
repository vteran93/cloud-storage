...
class TestSftpProvider(TestCase):
    ...
    def test_upload_to_sftp_server(self, sftp_connection_constructor_mock):
        ...
        expected_destination_path = "%s%s%s" % (
            self.__butcket_to_test, os.sep, file_path_to_upload)
        ...
        file_loaded_url = sftp_connection.upload(
            self.__butcket_to_test, file_path_to_upload + self.__file_name_to_test, file_path_to_upload)
